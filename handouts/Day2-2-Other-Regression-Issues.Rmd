...
```{r}
rmod <- lm(log_gdp ~ rugged*cont_africa, data=rugged)
summary(rmod)
```

How do you interpret it and what might be the reason for the seemingly differtn behavior of African countries?
